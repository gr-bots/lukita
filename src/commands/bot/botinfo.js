    ...
    run: async (client, interaction) => {
     ...
     const rowBotinfo = new ActionRowBuilder()
      ...
      let embedBotinfo = new EmbedBuilder()
        .setTitle(`${client.emotes.nothing}${client.emotes.nothing}${client.emotes.nothing}${client.emotes.nothing} ・Minhas informações principais・ ${client.emotes.nothing}${client.emotes.nothing}${client.emotes.nothing}${client.emotes.nothing}`)

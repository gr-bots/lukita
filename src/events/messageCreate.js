...
export default class MessageCreate extends Event {
  ...
  execute(client, message) {
    ...
    if(message.content == `<@${client.user.id}>`) {
      ...
      message.reply({ content: `> :man_raising_hand::skin-tone-1:・Olá **${message.author.username}**, sou um jovem disposto a deixar sua moderação muito mais fácil. Sou um bot feito em SlashCommands, sendo assim, use </help:998743092612055060> para ver meus comandos.`, components: [rowMention] })
    }
  }
}
